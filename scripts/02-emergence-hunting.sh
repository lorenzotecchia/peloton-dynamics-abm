...
uv run python scripts/gsa_sobol_heatmaps.py --sobol-dir /gpfs/work5/0/prjs2142/gsa-agent-dump-per-run/24244290-94c6e10-sobol-dump --out-dir data-SA/gsa_heatmaps-sobol-518-all-bins-filled-seq --bins 10 --slice-nearest 100000
