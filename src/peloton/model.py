    ...
    def __init__(
        ...
        **overrides,
        ...
        for i in range(config.n_agents):
            ...
            # Trained population may be a different size than the viz slider asks
            # for; reuse it cyclically and fall back to fresh coeffs if absent.
            coeffs = population[i % len(population)] if population else None
