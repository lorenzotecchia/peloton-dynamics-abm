...
class PelotonConfig:
    ...
    w_max10_mean: float = 450.0  # mean 10-min max power (W)
    ...
    utility_decay: float = (
        0.8  # lambda: exp decay of position-based utility (larger = steeper)
    )
    learning_rate: float = 0.1  # eta: coefficient update step
    evo_noise: float = 0.02  # std of Gaussian noise added each generation
